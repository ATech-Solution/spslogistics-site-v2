...
<head>
	...
	.entry--content .row{border-radius:15px;background:#fff;padding:20px;margin:0px 5px; }
	.error{border:solid 2px #B8D7DD;background:#EBF9FD;}
	.success{border:solid 2px #33A846;background:#F3FFF5;}
	.success .title{font-family: 'IBMPlexSans-SemiBold';font-size:24px;color:#000;}
	.success p{font-family: 'IBMPlexSans-Regular';font-size:16px;color:#000;}
...
<div id="wrapper" class="wrapper clearfix">	<!-- Header
	...
	===
	=== === === === === === === === === === === === === === -->
	<section id="blog" class="blog blog-single quotation">
		<div class="container">
			<div class="row">
					...
					<div class="blog-entry">
						...
						<div class="form-request">
							<div class="row"><!-- mail_handler_contact.php -->
								...
								<form id="contactForm" action="smtpmail/mail_send_quote.php" method="post" class="wow fadeInUp mb-0" data-wow-duration="1s">	
								<!-- <form action="mail_handler_contact.php" method="post" class="wow fadeInUp mb-0" data-wow-duration="1s"> -->
									<div class="col-xs-12 col-sm-12 col-md-12">
										<div class="col-xs-12 col-sm-12 col-md-12">
											<label class="form-label" for="country">From</label><span style="color: red !important; display: inline; float: none;">*</span>     
									        ...
									        <div class="col-xs-12 col-sm-12 col-md-12">    	
										<label class="form-label" for="country">To</label><span style="color: red !important; display: inline; float: none;">*</span>     
											...
											<label class="form-label">Length</label><span style="color: red !important; display: inline; float: none;">*</span> 
											<input type="text" class="form-control inputClass" name="length" placeholder="" required>
										</div>
										<div class="col-xs-12 col-sm-12 col-md-4">
											<label class="form-label">Width</label><span style="color: red !important; display: inline; float: none;">*</span> 
											<input type="text" class="form-control inputClass" name="length" placeholder="" required>
										</div>
										<div class="col-xs-12 col-sm-12 col-md-4">
											<label class="form-label">Height</label><span style="color: red !important; display: inline; float: none;">*</span> 
											<input type="text" class="form-control inputClass" name="length" placeholder="" required>
										</div>
										<div class="col-xs-12 col-sm-12 col-md-12">
											<label class="form-label">Weight</label><span style="color: red !important; display: inline; float: none;">*</span> 
											<input type="text" class="form-control inputClass" name="length" placeholder="" required>
										</div> 
									</div>	   
									...
									<div class="col-xs-12 col-sm-12 col-md-12">
										...
										<label class="form-label">Who product is it?</label><span style="color: red !important; display: inline; float: none;">*</span> 
										<input type="text" class="form-control inputClass" name="who-product" placeholder="" required>
										</div>
										<div class="col-xs-12 col-sm-12 col-md-6">
											<label class="form-label">Number of Package</label><span style="color: red !important; display: inline; float: none;">*</span> 
									...
									<div class="col-xs-12 col-sm-12 col-md-12">
										...
										<div class="col-xs-12 col-sm-12 col-md-5">
											<label class="form-label">Name</label><span style="color: red !important; display: inline; float: none;">*</span> 
											<input type="text" class="form-control inputClass" name="your-name" placeholder="" required>
										</div>
										<!-- .col-md-6 end -->
										<div class="col-xs-12 col-sm-12 col-md-5">
											<label class="form-label">Email*</label>
											<input type="email" class="form-control inputClass" name="your-email" placeholder="" required>
										</div>
										<!-- .col-md-6 end -->
										<div class="col-xs-12 col-sm-12 col-md-5">
											<label class="form-label">Whatsapp Number</label>
											<input type="number" class="form-control inputClass" name="your-wa-number" placeholder="" maxlength="9">
										</div>
									</div>		
